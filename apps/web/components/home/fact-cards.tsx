  ...
  return (
    <section className="mx-auto w-full max-w-6xl px-5 pt-20 sm:px-8">
      ...
      <div className="grid gap-5 md:grid-cols-2">
        <Reveal className="flex min-h-[22rem] flex-col rounded-[1.75rem] bg-muted p-7 sm:p-9">
          ...
          <div className="flex flex-1 items-center justify-center pb-6">
            <div className="flex w-full max-w-xs items-center justify-between gap-3 rounded-2xl bg-white px-5 py-6 shadow-sm">
              <div className="text-center">
                <p className="m-0 font-display text-2xl text-ink">₹4.85 Cr</p>
                <p className="m-0 pt-1 text-[11px] text-ink-muted">Ledger · p2</p>
              </div>
              <span className="rounded-full bg-bad-wash px-2.5 py-1 text-[11px] font-semibold text-bad-ink">≠</span>
              <div className="text-center">
        ...
        <Reveal delay={0.08} className="flex min-h-[22rem] flex-col rounded-[1.75rem] bg-muted p-7 sm:p-9">

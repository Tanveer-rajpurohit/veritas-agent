...
export function ScaleIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function GavelIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function HandshakeIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <path d="m11 17 2 2a1 1 0 0 0 1.4 0l4.3-4.3a1 1 0 0 0 0-1.4l-3-3a1 1 0 0 0-1.4 0l-3.3 3.3" />
      <path d="m13 14-4-4a1 1 0 0 0-1.4 0L3.3 14.3a1 1 0 0 0 0 1.4l3 3a1 1 0 0 0 1.4 0L11 15.4" />
      <path d="m18 11 3.3-3.3a1 1 0 0 0 0-1.4l-3-3a1 1 0 0 0-1.4 0L14 6" />
      <path d="m2 11 3.3-3.3a1 1 0 0 1 1.4 0L9 10" />
    </svg>
  );
}

export function PropertyHomeIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function ShieldAlertIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BuildingIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LandmarkIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LightbulbIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function SlidersIcon({ size = 15, className = "" }: IconProps) {
  return (
    ...
    >
      ...
      <line x1="12" x2="20" y1="14" y2="14" />
      <line x1="16" x2="20" y1="21" y2="21" />
      <line x1="20" x2="20" y1="7" y2="7" />
    </svg>
  );
}

export function ListFilterIcon({ size = 13, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function MoreHorizontalIcon({ size = 16, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BookOpenIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function UploadIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function CpuIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export const ComputeIcon = CpuIcon;

export function BotIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function AlertCircleIcon({ size = 15, className = "" }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
